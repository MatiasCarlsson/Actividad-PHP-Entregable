    ...
    <header class="header" id="mainHeader">
        ...
        <nav class="nav small">
            <?php if (is_logged()): ?>
                ...
                <?php if (is_admin()): ?>
                    <a href="pages/panelAdmin.php">Admin</a>
                <?php endif; ?>
            <?php else: ?>
                <a href="pages/registro.php">Registrarme</a>
    ...
    <main class="container">
                ...
                <?php foreach ($rows as $r): ?>
                    <div class="card" onclick="openModal(<?= (int) $r['id'] ?>)">
                        <div class="card-image-wrapper">
                            ...
                            if (!empty($r['foto']) && file_exists("img/" . $r['foto'])) {
                                echo '<img src="img/' . h($r['foto']) . '" alt="' . h($r['nombre']) . '">';
        ...
        <div class="modal-info">
          ...
          <div class="modal-actions">
            ${isLogged ? `
              <form method="post" action="processing/procesarVoto.php" style="flex: 1">
            ...
            ` : `
              <a href="pages/login.php" class="btn secondary" style="flex: 1; text-align: center; text-decoration: none;">
