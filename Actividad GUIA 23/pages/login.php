    ...
    <main class="container">
        ...
        <form class="form" method="post">
            ...
            <div class="row">
                <div>
                    ...
                    <input class="input" name="nombre" maxlength="50" required
                        value="<?= h($_POST['nombre'] ?? '') ?>" placeholder="Tu nombre de usuario">
                </div>
            ...
            <p style="text-align:center; margin-top:1rem">
                ¿No tienes cuenta? <a href="registro.php"
                    style="color:var(--accent); text-decoration:none; font-weight:600">Regístrate
                    aquí</a>
            </p>
        </form>
    </main>
